...
import { NameStateEntity_APP, NameStateEntity_APPDTO, NameStateEntity_ListResponse, NameStateEntity_PageResponse, NameStateEntity_Response, FormControlOption, TypeReturn, NameStateEntity_DTO } from '@interfaces/index';
...
export class ManualTariffMedicineService {
    private http = inject(HttpClient);
    private api: PathNameAPI = {
        base: 'm-tarifa-medicamento',
        save: 'save',
        list: 'lista',
        page: 'page',
    };
