...
import { DetailServiceProgramsComponent } from '../../service-programs/detail-service-programs/detail-service-programs.component';

@Component({
    selector: 'detail-care-programs',
    imports: [
        ...
        DetailServiceProgramsComponent
    ],
    templateUrl: './detail-care-programs.component.html'
})
export class DetailCareProgramsComponent {
