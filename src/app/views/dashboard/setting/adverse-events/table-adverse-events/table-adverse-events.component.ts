...
@Component({
  selector: 'table-adverse-events',
  imports: [
        BladeTableComponent,
        DirectivesModule,
        BtnsActionComponent
    ],
  templateUrl: './table-adverse-events.component.html'
})
export class TableAdverseEventsComponent {
    public onTable = output<onBtn<NameIdEntity_APP>>();
    private CashReceiptConcept$ = inject(AdverseEventsService);
